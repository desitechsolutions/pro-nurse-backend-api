...
-- Document review history (append-only audit trail)
...
CREATE TABLE IF NOT EXISTS payout_requests (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    nurse_wallet_id BIGINT NOT NULL,
    amount DECIMAL(10,2) NOT NULL,
    status VARCHAR(20) DEFAULT 'PENDING',
    processed_at TIMESTAMP,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (nurse_wallet_id) REFERENCES nurse_wallets(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS favorite_nurses (
    ...
    FOREIGN KEY (nurse_user_id) REFERENCES users(id) ON DELETE CASCADE,
    UNIQUE (patient_user_id, nurse_user_id)
);
